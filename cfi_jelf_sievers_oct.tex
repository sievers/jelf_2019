...
matrix multiplies.  In other words, the correlator one would design today is
radically different from the one CHIME deployed last year.
Conversely, the digitizing, channelizing, and corner-turning operations
...
deployed to South Africa for HIRAX for 4-5 years, and then redeployed
to northern Canada with a new, by then much-cheaper and lower power,
GPU engine.

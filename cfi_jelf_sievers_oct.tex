...
matrix multiplies.  In other words, the correlator one would design
today is radically different from the one CHIME deployed last year.
...
\begin{figure}[t]
  ...
  \includegraphics[height=1.4in]{rebcon_8element.jpg}
...
\begin{figure}[t]
  \includegraphics[height=2.1in]{d3a_team.png}
%  \includegraphics[height=2.5in]{rebcon_dish.png}
  \includegraphics[height=2.1in]{mms_dish_kavi.jpg}
...
{\color{red}HIRAX has already received a total commitment of
  ...
  collaborators have secured 393,000 CHF (520,000 CAD) to build a GPU
...
intelligence techniques have to offer.  {\color{red} The above data-

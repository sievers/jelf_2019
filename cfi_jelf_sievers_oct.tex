...
scale deployments of the \mbe\ make road-accessible regions of Qu\'ebec
...
required for these test deployments from C150 funds.  {\color{blue}We
  have already begun preliminary testing along the Route de la Baie-James and
  the Route du Nord.  Early results are promising enough to merit
  further testing, especially at frequencies above 400 MHz.}
